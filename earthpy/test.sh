...
#python3 cli.py retrieve --data srtm --format r16 --res 4033 4033 --dimen 2 2 --bbox -120.0 34.0 -118.0 36.0
python3 cli.py retrieve --data srtm --format r16 --res 4033 4033 --dimen 2 2 --bbox -120.0 34.0 -119.0 35.0
